...
<nav className="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="https://e7.pngegg.com/pngimages/151/227/png-clipart-black-logo-illustration-minimalism-tattoo-geometry-logo-free-buckle-triangle-element-angle-free-logo-design-template-thumbnail.png" className="h-8" alt="Flowbite Logo" />
